        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Control de mesas</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>11-7-2014</td>
                  <td><span class="label label-warning">Pendiente de aprobar</span></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>Bob Doe</td>
                  <td>11-7-2014</td>
                  <td><span class="label label-primary">No disponible</span></td>                 
                </tr>
                <tr>
                  <td>4</td>
                  <td>Mike Doe</td>
